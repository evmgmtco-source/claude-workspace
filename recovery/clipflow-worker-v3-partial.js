// ClipFlow â Raycast-style site + command-driven dashboard
...
// ââ Shared marketing CSS ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const MKT_CSS = `
...
<nav><div class="wrap">
<a class="logo" href="/"><span class="dot">â¶</span>ClipFlow</a>
...
<div class="cols">
<div class="col brand"><a class="logo" href="/"><span class="dot">â¶</span>ClipFlow</a><p>Turns Kick streams into TikTok-ready clips. Detected, cropped, captioned and queued â automatically.</p></div>
...
<div class="base"><span>Â© 2026 ClipFlow Â· operated by EV Management Co</span><span>evmgmtco@gmail.com</span>${activeNote}</div>
</div></footer>
<script>
(function(){
...
<div class="wrap hero">
<div class="kicker"><i></i>Command-first clipping for Kick streamers <kbd>âK</kbd></div>
<h1>Turn livestreams into<br><span class="grad">viral TikTok clips</span> instantly</h1>
<p class="sub">ClipFlow watches your Kick stream, cuts vertical highlights with captions, and queues them to TikTok â all from one command bar.</p>
<div class="cta"><a class="btn acc" href="/dashboard">Open Dashboard</a><a class="btn" href="/features">Watch demo</a></div>
<p style="margin-top:16px;font-size:12px;color:var(--dim2)" class="mono">Web app Â· works with any Kick VOD Â· no OBS plugins</p>
...
<div class="prow on"><span class="pi"><svg viewBox="0 0 24 24"><path d="M12 3v12"/><path d="m7 8 5-5 5 5"/><path d="M4 21h16"/></svg></span><span class="pn">Upload clip</span><span class="pd">from a Kick VOD link</span><span class="sp"></span><kbd>âµ</kbd></div>
<div class="prow"><span class="pi"><svg viewBox="0 0 24 24"><path d="M4 7h16M4 12h10M4 17h7"/></svg></span><span class="pn">Generate caption</span><span class="pd">AI title + hashtags</span><span class="sp"></span><kbd>âG</kbd></div>
<div class="prow"><span class="pi"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg></span><span class="pn">Schedule TikTok post</span><span class="pd">queue for peak hours</span><span class="sp"></span><kbd>âS</kbd></div>
<div class="prow"><span class="pi"><svg viewBox="0 0 24 24"><path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/></svg></span><span class="pn">Find viral clips</span><span class="pd">detect chat spikes in your VOD</span><span class="sp"></span><kbd>âF</kbd></div>
<div class="pfoot"><span>ClipFlow</span><span class="sp"></span><span>navigate <kbd>â</kbd> <kbd>â</kbd></span><span>run <kbd>âµ</kbd></span></div>
</div>
<script>
(function(){
...
<div class="libc"><div class="cat">Library</div><h3>Clip library</h3><p>Every highlight stored for 30 days â post an older moment when a game blows up.</p></div>
...
<p>You already know when the clip happened â <b>your chat told you.</b> ClipFlow reads chat velocity, emote bursts and viewer spikes across the whole VOD and marks the exact seconds worth posting.</p>
...
<div class="spike">
<div class="lbl"><span>chat velocity Â· msgs/10s</span><span>VOD 01:38:00â01:46:00</span></div>
...
<div class="mark"><i></i><span><b style="color:var(--ink);font-weight:550">Highlight detected</b> at 01:42:16 Â· confidence 0.94</span><kbd>âµ clip</kbd></div>
</div>
</div>
</div></section>
...
<p class="lede">If you're live on Kick, your best marketing already happened â it's sitting in your VODs.</p>
<div class="personas">
<div class="persona"><div class="who">The grinder</div><h3>Streams daily, posts never</h3><p>Four hours live, five nights a week â and a TikTok that's been quiet for a month. ClipFlow turns every stream into next-day posts without adding a minute to your schedule.</p></div>
<div class="persona"><div class="who">The growth streamer</div><h3>Knows shorts drive discovery</h3><p>TikTok is where new viewers find you; the stream is where they stay. Keep a consistent posting cadence without paying an editor Â£400 a month.</p></div>
<div class="persona"><div class="who">The variety streamer</div><h3>Every game, one pipeline</h3><p>IRL, gaming, react content â chat spikes look the same everywhere. One workflow that follows whatever you stream next.</p></div>
</div>
</div></section>
...
<div class="stat"><div class="v">Â£9.99<span style="font-size:14px;color:var(--dim2)">/mo</span></div><div class="k">vs Â£400+/mo for a human clipper</div></div>
</div>
</div></section>
...
<div class="faq">
<details><summary>How does it work without OBS plugins or downloads?</summary><p>ClipFlow works from your public Kick VODs. Paste a VOD link â or let highlight detection scan it â and the pipeline downloads just the section it needs, renders it vertical, and hands you the MP4. Nothing to install, nothing running on your streaming PC.</p></details>
<details><summary>Do I need to connect my TikTok account?</summary><p>Not to make clips. Download and post them yourself from day one. Direct posting and scheduling use TikTok's official Content Posting API, which is currently in review â it unlocks automatically for your account once approved.</p></details>
<details><summary>How good is the highlight detection, really?</summary><p>It reads what your chat already did: message velocity, emote bursts and viewer spikes. Those signals line up with clippable moments far more reliably than scrubbing a timeline â and you always review before anything is posted.</p></details>
<details><summary>What does it cost?</summary><p>One plan: Â£9.99/month, billed through Stripe. That's less than an hour of a human editor's time. Cancel anytime and keep access until the end of the paid period.</p></details>
<details><summary>Who owns the clips?</summary><p>You do â entirely. ClipFlow processes your stream content solely to make your clips, never sells data or trains AI on your content, and deletes clips after 30 days. Details in our <a href="/privacy" style="color:var(--acc)">Privacy Policy</a>.</p></details>
<details><summary>I'm not on Kick. Will you support other platforms?</summary><p>Kick first, done properly. Other platforms are on the roadmap â email <a href="mailto:evmgmtco@gmail.com" style="color:var(--acc)">evmgmtco@gmail.com</a> and tell us where you stream.</p></details>
</div>
</div></section>
...
<div class="comm">
<a class="commc" href="https://x.com/evclaude00"><span class="k">X / Twitter</span><b>@evclaude00</b><p>Build updates, feature drops and clips from the pipeline as they ship.</p><span class="go">Follow â</span></a>
...
// ââ Marketing + legal pages (content preserved for TikTok review) âââââââââââââ
...
<div class="card w3"><div class="ic"><svg viewBox="0 0 24 24"><path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/></svg></div><h3>Highlight detection</h3><p>Chat velocity and emote-burst analysis finds the moments your viewers actually reacted to â not random timestamps.</p></div>
...
<div class="card"><div class="ic"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg></div><h3>Post scheduling</h3><p>Queue approved clips for the hours your audience is on TikTok. One a day or ten â your call.</p></div>
...
<div class="card w6"><div class="ic"><svg viewBox="0 0 24 24"><path d="m21 3-9 9"/><path d="M21 3 14 21l-3-8-8-3z"/></svg></div><h3>TikTok integration <span class="pill q">beta</span></h3><p>Direct posting via TikTok's official Content Posting API. Currently in review â beta users post via one-tap export in the meantime.</p></div>
</div></div></section>`);

const PRICING = page('Pricing', `
<div class="wrap hero">
<div class="kicker"><i></i>Pricing</div>
<h1>One plan.<br><span class="grad">No editorsâ fees.</span></h1>
<p class="sub">A human clipper runs Â£400+/month. Your own time in CapCut costs every evening. ClipFlow is Â£9.99.</p>
<div class="price">
<span class="beta">Early access</span>
<div class="amt">Â£9.99<span>/month</span></div>
<ul>
...
<p style="color:var(--dim2);font-size:12.5px;margin-top:16px">ClipFlow is in early access while our TikTok integration completes review. Request access and we'll onboard you personally â you're only billed when your account is live.</p>
</div>
</div>`);
...
<li><b>Connected platforms:</b> your public Kick.com channel name, and â if you connect TikTok â the access token TikTok issues us to post on your behalf. We never see or store your TikTok password.</li>
...
<h2>Third parties</h2>
<p>We use Cloudflare (hosting), Railway (processing), Stripe (payments â card details go directly to Stripe and never touch our servers), and the official TikTok API (posting, only with your authorisation). Each processes data under its own privacy policy.</p>
<h2>Your rights</h2>
...
<h2>5. Billing</h2>
<p>ClipFlow costs Â£9.99/month, billed via Stripe, starting only when your account is activated. Cancel anytime from your dashboard or by emailing us; access continues to the end of the paid period. Statutory refund rights are unaffected.</p>
...
// ââ Dashboard: Raycast-style command-driven app âââââââââââââââââââââââââââââââ
const APP_CSS = `
...
<title>Dashboard â ClipFlow</title>${FONTS}<style>${APP_CSS}</style></head><body>
<div class="shell">
<aside class="side">
...
<div class="main">
<div class="topbar">
<button class="cmdbtn" id="opencmd">${IC.find}<span>Search actions, clips, analyticsâ¦</span><span class="sp"></span><kbd>â</kbd><kbd>K</kbd></button>
<span class="tsp"></span>
...
<div id="syslog">
<div class="logline"><em>[pipeline]</em> vertical encoder warm Â· 720Ã1280</div>
...
<div class="pal">
<div class="pin">${IC.find}<input id="cmdin" placeholder="Type a commandâ¦" autocomplete="off"></div>
<div class="list" id="cmdlist"></div>
<div class="pfoot"><span>ClipFlow</span><span class="rsp"></span><span>navigate <kbd>â</kbd> <kbd>â</kbd></span><span>run <kbd>âµ</kbd></span><span>close <kbd>esc</kbd></span></div>
</div>
</div>
...
<div class="field"><label for="cu">Kick VOD URL</label><input id="cu" placeholder="https://kick.com/video/â¦" autocomplete="off"></div>
<div class="f2">
...
<div class="pstate" id="pstate">Processing AI highlightsâ¦</div>
...
<div class="field"><label for="du">Kick VOD URL</label><input id="du" placeholder="https://kick.com/video/â¦" autocomplete="off"></div>
<div class="prog" id="dprog"><i></i></div>
<div class="pstate" id="dpstate">Scanning chat activityâ¦</div>
<div id="dres"></div>
...
var feed=[
 ...
 {dot:'ok',html:'<b>Clip processed</b> Â· 28s vertical render',when:'14m'},
 {dot:'warn',html:'<b>TikTok posting</b> queued â API in review',when:'1h'}
];
var queue=0;
...
function log(m){var d=document.createElement('div');d.className='logline';d.innerHTML=m;var sl